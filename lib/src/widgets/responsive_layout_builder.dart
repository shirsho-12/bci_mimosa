  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= MimosaBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= MimosaBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= MimosaBreakpoints.large) {
